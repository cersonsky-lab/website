...
- **scikit-matter : A Suite of Generalisable Machine Learning Methods Born out of Chemistry and Materials Science** – Alexander Goscinski, Christian A Jorgensen, Victor Paul Principe, Guillaume Fraux, Sergei Kliavinek, Benjamin A. Helfrecht, Philip Loche, Rhushil Vasavada, Michele Ceriotti, _**RKC**_, _Open Research Europe_ _3_, 81 [Link](https://open-research-europe.ec.europa.eu/articles/3-81/v3).
- **Open Dataset** - **Photonic densities of states and band structures for photonic band gap crystals** – _**RKC**_ [Link](https://zenodo.org/records/17536659).
...
- **A Broader View Part 2: Reframing Assessment Tools in the Era of LLMs** – _**RKC**_, _Computational Molecular Science and Engineering Forum, American Institute of Chemical Engineers_ [Link](http://comsef.org/sites/comsef.org/files/2025-10-CoMSEF.pdf).
...
- **Expanding density-correlation machine learning representations for anisotropic coarse-grained particles** – Arthur Y. Lin, Kevin K. Huguenin-Dumittan, Yong-Cheol Cho, Jigyasa Nigam, _**RKC**_, _The Journal of Chemical Physics_ _161_ (7), 074112 [Link](https://doi.org/10.1063/5.0210910).
